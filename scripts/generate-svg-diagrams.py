...
def generate_architecture_svg(output_path: Path):
  ...
  <!-- Title & Legend -->
  <text x="40" y="44" font-size="22" font-weight="700" fill="#f8fafc">ER-DMARC-Monitor · System Architecture &amp; Data Pipeline</text>
  <text x="40" y="68" font-size="13" fill="#94a3b8">Interactive Service Topology, Ingress Relay / Reverse Proxy &amp; Processing Pipeline</text>

  <!-- External MTAs -->
  <g transform="translate(30, 115)">
    <rect width="170" height="90" rx="10" fill="#1e293b" stroke="#f43f5e" stroke-width="1.5" filter="url(#cardGlow)"/>
    <rect width="170" height="26" rx="10" fill="#f43f5e" fill-opacity="0.2"/>
    <text x="14" y="20" font-size="12" font-weight="600" fill="#fda4af">EXTERNAL INGEST</text>
    <text x="14" y="52" font-size="14" font-weight="700" fill="#ffffff">External Mail Servers</text>
    <text x="14" y="72" font-size="11" fill="#94a3b8">MTAs (Google, MS, etc.)</text>
  </g>

  <!-- Arrow 1a: MTA -> Reverse Proxy (Port 25) -->
  <path d="M 200 160 L 235 160" stroke="#f43f5e" stroke-width="2" marker-end="url(#arrow-blue)"/>
  <text x="202" y="152" font-size="10" font-weight="700" fill="#fda4af">Port 25</text>

  <!-- Optional / Production Ingress Intermediate: Reverse Proxy / Port Forwarder -->
  <g transform="translate(245, 110)">
    <rect width="135" height="100" rx="8" fill="#1e293b" stroke="#f59e0b" stroke-width="1.5" stroke-dasharray="3,3" filter="url(#cardGlow)"/>
    <rect width="135" height="24" rx="8" fill="#f59e0b" fill-opacity="0.2"/>
  ...
  <!-- Direct Local / Dev Bypass line (Direct Port 2525) -->
  <path d="M 115 115 L 115 90 L 460 90 L 460 110" stroke="#38bdf8" stroke-width="1.5" stroke-dasharray="4,4" fill="none" marker-end="url(#arrow-blue)"/>
  <text x="215" y="84" font-size="10" fill="#38bdf8">Direct Dev / Testing (Port 2525)</text>

  <!-- Arrow 1b: Reverse Proxy -> SMTP Ingester (Port 2525) -->
  <path d="M 380 160 L 405 160" stroke="#38bdf8" stroke-width="2" marker-end="url(#arrow-blue)"/>
  <text x="382" y="152" font-size="10" fill="#38bdf8">2525</text>

  <!-- Service: SMTP Ingester -->
  <g transform="translate(415, 115)">
    <rect width="180" height="95" rx="10" fill="#1e293b" stroke="#3b82f6" stroke-width="1.5" filter="url(#cardGlow)"/>
    <rect width="180" height="26" rx="10" fill="#3b82f6" fill-opacity="0.2"/>
    <text x="14" y="20" font-size="12" font-weight="600" fill="#93c5fd">INGEST SERVICE</text>
    <text x="14" y="52" font-size="15" font-weight="700" fill="#ffffff">smtp-ingester</text>
    <text x="14" y="70" font-size="11" fill="#94a3b8">aiosmtpd (Port 2525)</text>
    <text x="14" y="86" font-size="10" fill="#64748b">Extracts .zip/.gz XML</text>
  </g>

  <!-- Arrow 2: SMTP Ingester -> Redis -->
  <path d="M 595 160 L 635 160" stroke="#38bdf8" stroke-width="2" marker-end="url(#arrow-blue)"/>
  <text x="598" y="152" font-size="10" fill="#38bdf8">LPUSH</text>

  <!-- Broker: Redis Queue -->
  <g transform="translate(645, 115)">
    <rect width="170" height="95" rx="10" fill="#1e293b" stroke="#e11d48" stroke-width="1.5" filter="url(#cardGlow)"/>
    <rect width="170" height="26" rx="10" fill="#e11d48" fill-opacity="0.2"/>
    <text x="14" y="20" font-size="12" font-weight="600" fill="#fda4af">MESSAGE BROKER</text>
    <text x="14" y="52" font-size="15" font-weight="700" fill="#ffffff">Redis Queue</text>
    <text x="14" y="70" font-size="11" fill="#94a3b8">Spool (dmarc_jobs)</text>
    <text x="14" y="86" font-size="10" fill="#64748b">Port 6379</text>
  </g>

  <!-- Arrow 3: Redis -> DMARC Parser -->
  <path d="M 730 210 L 730 310" stroke="#38bdf8" stroke-width="2" marker-end="url(#arrow-blue)"/>
  <text x="740" y="265" font-size="11" fill="#38bdf8">BRPOP</text>
