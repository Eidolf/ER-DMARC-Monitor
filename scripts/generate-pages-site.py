  ...
  <aside class="sidebar">
    <div class="sidebar-header">
      ...
      <div style="display: flex; gap: 0.35rem; margin-top: 0.5rem; flex-wrap: wrap;">
        <a href="../index.html" class="diagram-btn" style="flex: 1; min-width: 60px; display: inline-flex; align-items: center; gap: 0.25rem; text-decoration: none; font-size: 0.76rem; justify-content: center; padding: 0.35rem 0.4rem;">
          <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 19"></polyline></svg>
          Home
        </a>
        <a href="../qa-security-site/index.html" class="diagram-btn" style="flex: 1; min-width: 70px; display: inline-flex; align-items: center; text-decoration: none; font-size: 0.76rem; justify-content: center; padding: 0.35rem 0.4rem; border-color: rgba(16, 185, 129, 0.4);">
          QA
        </a>
        <a href="../testing-audit-site/index.html" class="diagram-btn" style="flex: 1; min-width: 80px; display: inline-flex; align-items: center; text-decoration: none; font-size: 0.76rem; justify-content: center; padding: 0.35rem 0.4rem; border-color: rgba(56, 189, 248, 0.4); color: #7dd3fc;">
          Auditor &rarr;
        </a>
      </div>
    </div>
